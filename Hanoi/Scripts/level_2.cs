...
public partial class level_2 : Node2D
{
	...
	public override void _Ready()
	{
		...
		levelGenerator niveau = new levelGenerator(2) ;
	...
	public override void _Process(double delta)
	{
		...
		if(levelGenerator.nbDisqueC == levelGenerator.nbDisqueTotal)
		{
			...
			GD.Print("Win !!!!!");
			GetTree().ChangeSceneToFile("res://Scenes/level_2_complete.tscn") ;
		}
		else if (levelGenerator.nbDeplacement == 0)
			{
				levelGenerator.Supprimer() ;
				GetTree().ChangeSceneToFile("res://Scenes/level_2_game_over.tscn");
			}
	}
