...
public partial class level_3 : Node2D
{
	...
	public override void _Ready()
	{
		...
		levelGenerator niveau = new levelGenerator(3) ;
	...
	public override void _Process(double delta)
	{
		...
		if(levelGenerator.nbDisqueC == levelGenerator.nbDisqueTotal)
		{
			...
			GD.Print("Win !!!!!");
			GetTree().ChangeSceneToFile("res://Scenes/level_3_complete.tscn") ;
		}
		else if (levelGenerator.nbDeplacement == 0)
			{
				levelGenerator.Supprimer() ;
				GetTree().ChangeSceneToFile("res://Scenes/level_3_game_over.tscn");
			}
	}
