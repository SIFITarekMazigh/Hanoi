...
public partial class level_1 : Node2D
{
	...
	{
		levelGenerator niveau = new levelGenerator(1) ;
		...
		GD.Print("nbDeplacement = ", levelGenerator.nbDeplacement);
	...
	public override void _Process(double delta)
	{
		...
		if (levelGenerator.nbDisqueC == levelGenerator.nbDisqueTotal)
		{
			...
			GD.Print("win");
			GetTree().ChangeSceneToFile("res://Scenes/level_1_complete.tscn");
		}
		else if (levelGenerator.nbDeplacement == 0)
			{
				levelGenerator.Supprimer() ;
				GetTree().ChangeSceneToFile("res://Scenes/level_1_game_over.tscn");
			}
	}
